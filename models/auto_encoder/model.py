...
class Decoder(torch.nn.Module):
    def __init__(self, flattened_dim, rebuild_shape):
        ...
        self.conv4 = torch.nn.ConvTranspose2d(in_channels=32, out_channels=64, kernel_size=3, stride=1, padding=1)
        self.conv3 = torch.nn.ConvTranspose2d(in_channels=64, out_channels=128, kernel_size=3, stride=1, padding=1)
